  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Tabs defaultValue={initialTab} className="glass-card p-8">
          ...
          <TabsContent value="signin">
            ...
            <div className="flex gap-2 mb-6">
              <Button
                ...
                size="sm"
                className="flex-1"
                onClick={() => { setLoginMethod("email"); setOtpSent(false); setOtpCode(""); }}
              >
                {t("auth.email", "Email")}
              </Button>
              <Button
            ...
            {loginMethod === "email" ? (
              ...
              <div className="space-y-4">
                {!otpSent ? (
                  <>
                    <div>
                      <label htmlFor="phone-number" className="block text-sm font-semibold mb-2">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        {t("auth.phoneHint", "Enter the phone number linked to your account, including country code")}
                      </p>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => setRememberMe(checked === true)}
                      />
                      <Label htmlFor="remember-me-phone" className="text-sm text-muted-foreground cursor-pointer">
                        {t("auth.rememberMe", "Remember me")}
                      </Label>
                    </div>
                    <Button
                  ...
                  <>
                    <div className="text-center">
                      <p className="text-sm text-muted-foreground mb-4">
                        {t("auth.otpSent", "Enter the 6-digit code sent to")} <strong>{phoneNumber}</strong>
                      </p>
                    ...
                    >
                      {otpLoading ? "Verifying..." : t("auth.verifyAndSignIn", "Verify & Sign In")}
                    </Button>
                    <Button
                      type="button"
                      variant="ghost"
