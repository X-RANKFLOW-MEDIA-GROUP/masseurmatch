...
const Privacy = () => (
  ...
  >
    ...
    <h2>1. Scope</h2>
    <p>This Policy applies to all users of <a href="https://www.masseurmatch.com">www.masseurmatch.com</a>, including visitors, therapists, advertisers, and directory subscribers. It does not apply to third-party websites linked from the Platform.</p>
    ...
    <ul>
      ...
      <li>Cookies and tracking technologies (see <Link href="/cookies">Cookie Policy</Link>, Section 4)</li>
    </ul>
