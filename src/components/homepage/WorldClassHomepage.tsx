...
const TICKER_ITEMS: TickerItem[] = [
  ...
  { text: "LGBTQ+ Therapist", highlight: true },
];
...
const NEIGHBORHOODS: Neighborhood[] = [
  ...
  { city: "Dallas, TX", name: "Uptown", count: "62 active therapists", tags: ["Swedish", "Hot Stone", "Couples"], href: "/dallas/areas/uptown" },
  { city: "Dallas, TX", name: "Deep Ellum", count: "38 active therapists", tags: ["CBD Body Work", "Myofascial"], href: "/dallas/areas/deep-ellum" },
  ...
  { city: "Houston, TX", name: "The Heights", count: "57 active therapists", tags: ["Sports", "Lymphatic"], href: "/houston/areas/the-heights" },
  { city: "Houston, TX", name: "Midtown", count: "73 active therapists", tags: ["Couples", "Hot Stone", "LGBTQ+"], href: "/houston/areas/midtown" },
  ...
  { city: "Austin, TX", name: "East Austin", count: "44 active therapists", tags: ["Swedish", "Myofascial", "LGBTQ+"], href: "/austin/areas/east-austin" },
  { city: "San Antonio, TX", name: "King William", count: "31 active therapists", tags: ["Hot Stone", "Swedish"], href: "/san-antonio/areas/king-william" },
];
...
const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    name: "Sam O., LMT",
    initials: "SO",
    meta: "South Congress, Austin TX \u00b7 Active Therapist",
    color: "var(--n0)",
  },
];
...
const FAQ_ITEMS: FaqItem[] = [
  {
    ...
    answer:
      "MasseurMatch was built with LGBTQ+ inclusivity at its foundation. Every therapist is reviewed, and those who explicitly identify as gay-affirming or queer-welcoming are highlighted with member badges. Every body and identity is welcome here.",
  },
  {
    question: "How do I find a gay-affirming massage therapist near me?",
    answer:
      'Use our search to enter your city or neighborhood — including specific areas like Oak Lawn in Dallas or Montrose in Houston — and filter by "LGBTQ+ Affirming". Results show reviewed therapists closest to you with their certifications and client reviews.',
  },
  {
    question: "Are therapists on MasseurMatch reviewed before listing?",
    answer:
      "Every therapist completes a profile review before being published. We do NOT verify professional licenses or credentials against state boards. MasseurMatch is a discovery directory — clients should confirm licensing independently. LGBTQ+-affirming status is self-reported by therapists.",
  },
  {
        ...
        <div className="wc-hero-split">
          ...
          <div className="wc-hero-content wc-hero-left">
            ...
            <p className="wc-hero-p">
              The premier LGBTQ+-inclusive directory with trusted profile quality,
            ...
            <div className="wc-hero-stats">
              <div className="wc-hstat">
                ...
                <div className="wc-hstat-l">Active Therapists</div>
              </div>
              <div className="wc-hstat">
                <div className="wc-hstat-n">
                  <b>{cityCount}</b>
            ...
            {[
              {
                ...
                body: "Filter by specialty, LGBTQ+ affirming, neighborhood, and price. Every profile is reviewed before publishing.",
                icon: (
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
              ...
              },
              {
                ...
                body: "Read client reviews, detailed profiles, and session details. Know exactly who you'll be working with.",
                icon: (
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
      ...
      <section className="wc-inc-sec">
        <div className="wc-inc-inner wc-cr2">
          ...
          <p className="wc-inc-body">
            ...
            are reviewed and highlighted across Oak Lawn, Montrose, South Congress, and 100+ cities
      ...
      <section className="wc-cta-sec">
        <div className="wc-cta-inner wc-cr2">
          ...
          <p className="wc-cta-b">
            Join thousands of clients who found their perfect gay-affirming match. Browse independent
