      ...
      <div className="main">
        ...
        <div className="left-col">
          ...
          <section className="anim-2">
            ...
            <div style={{ background: 'rgba(255,138,31,0.05)', border: '1px dashed rgba(255,138,31,0.4)', padding: 24, borderRadius: 4 }}>
              ...
              <div style={{ display: 'flex', gap: 10, marginBottom: 12, flexWrap: 'wrap' }}>
                <select style={{ padding: 10, border: '1px solid rgba(11,31,58,0.1)', borderRadius: 2, fontFamily: 'var(--font-inter, Inter, sans-serif)', fontSize: 13, outline: 'none', background: 'white', flex: 1, minWidth: 120 }}>
                  <option>Deep Tissue</option>
                  <option>Shiatsu</option>
                  <option>Swedish</option>
                  <option>Sports/Fitness</option>
                </select>
                <input type="text" placeholder="Focus area? (e.g., Lower back)" style={{ padding: 10, border: '1px solid rgba(11,31,58,0.1)', borderRadius: 2, fontFamily: 'var(--font-inter, Inter, sans-serif)', fontSize: 13, outline: 'none', flex: 2, minWidth: 150 }} />
              </div>
          ...
          <section>
            ...
            {aiSummary && <div style={{ background: '#FFF8F0', borderLeft: '3px solid var(--orange)', padding: 16, marginBottom: 24, borderRadius: '0 4px 4px 0' }}>
              <div style={{ fontFamily: 'var(--font-jetbrains-mono, JetBrains Mono, monospace)', fontSize: 10, color: 'var(--orange)', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 6 }}>✨ Generated by Gemini AI</div>
        ...
        <aside className="sidebar">
          ...
          <div className="info-card anim-1" style={{ border: '1px solid rgba(255,138,31,0.3)', background: 'linear-gradient(180deg, #FCFBF8 0%, #FFF8F0 100%)' }}>
            ...
            <textarea placeholder="E.g., My lower back hurts from sitting all day..." style={{ width: '100%', padding: 10, border: '1px solid rgba(11,31,58,0.1)', borderRadius: 2, fontFamily: 'var(--font-inter, Inter, sans-serif)', fontSize: 13, marginBottom: 10, resize: 'vertical', minHeight: 60, outline: 'none' }} />
          ...
          <div className="book-card anim-2">
            ...
            <div className="book-body">
              ...
              <div className="avail-row">
                ...
                <span className="avail-val" style={{ color: 'var(--orange)', fontSize: 18, fontFamily: 'var(--font-space-grotesk, Space Grotesk, sans-serif)', fontWeight: 600 }}>$160 / 60 min</span>
              </div>
          ...
          <div className="info-card anim-4" style={{ borderColor: 'var(--orange)' }}>
            ...
            <input type="text" placeholder="To: (Name)" style={{ width: '100%', padding: 8, border: '1px solid rgba(11,31,58,0.1)', borderRadius: 2, fontFamily: 'var(--font-inter, Inter, sans-serif)', fontSize: 12, marginBottom: 8, outline: 'none' }} />
            <input type="text" placeholder="Occasion: (e.g., Birthday, Stress Relief)" style={{ width: '100%', padding: 8, border: '1px solid rgba(11,31,58,0.1)', borderRadius: 2, fontFamily: 'var(--font-inter, Inter, sans-serif)', fontSize: 12, marginBottom: 12, outline: 'none' }} />
            ...
            {aiGiftResult && <div style={{ marginTop: 12, fontFamily: 'var(--font-space-grotesk, Space Grotesk, sans-serif)', fontSize: 16, fontStyle: 'italic', color: 'var(--navy)', background: '#FFF8F0', padding: 12, borderRadius: 4, borderLeft: '2px solid var(--orange)' }}>{aiGiftResult}</div>}
          </div>
