      ...
      <form onSubmit={submitInquiry} className="flex flex-col gap-4">
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="rounded-lg border border-white/10 bg-white/[0.04] px-3 py-2.5 text-sm text-white placeholder:text-slate-500 focus:border-orange-500/50 focus:outline-none focus:ring-1 focus:ring-orange-500/20"
            />
          </div>
          <div className="flex flex-col gap-1.5">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <select
              ...
              className="rounded-lg border border-white/10 bg-[#0d1829] px-3 py-2.5 text-sm text-white focus:border-orange-500/50 focus:outline-none focus:ring-1 focus:ring-orange-500/20"
            >
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <textarea
            ...
            className="resize-none rounded-lg border border-white/10 bg-white/[0.04] px-3 py-2.5 text-sm text-white placeholder:text-slate-500 focus:border-orange-500/50 focus:outline-none focus:ring-1 focus:ring-orange-500/20"
          />
        </div>
        <button
          type="submit"
          disabled={loading}
          className="flex items-center justify-center gap-2 rounded-lg bg-[#FF8A1F] px-5 py-3 text-sm font-semibold text-white transition-all hover:bg-orange-400 disabled:opacity-60"
        >
          {loading ? (
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex gap-2">
          <input
            ...
            placeholder="Reply…"
            disabled={loading}
            className="flex-1 rounded-lg border border-white/10 bg-white/[0.04] px-3 py-2.5 text-sm text-white placeholder:text-slate-500 focus:border-orange-500/50 focus:outline-none disabled:opacity-60"
          />
          <button
            onClick={sendChatMessage}
            disabled={loading || !chatInput.trim()}
            className="flex items-center justify-center rounded-lg bg-[#FF8A1F] px-3 py-2.5 transition-all hover:bg-orange-400 disabled:opacity-60"
          >
        ...
        {step === 'chat' && (
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-lg border border-white/10 bg-white/[0.04] px-4 py-2.5 text-sm text-slate-300 transition-all hover:border-orange-500/40 hover:text-white"
          >
