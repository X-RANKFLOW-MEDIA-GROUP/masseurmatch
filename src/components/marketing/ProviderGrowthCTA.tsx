        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          >
            ...
            <p className="mt-8 text-lg leading-relaxed text-[#6F6F6F]">
              Join a curated directory built for serious massage therapists who want to reach clients in a
              professional, LGBTQ+-affirming environment. MasseurMatch is a discovery directory, not a booking
              platform. Clients contact providers directly.
            </p>
            ...
            <div className="mt-12 flex flex-wrap gap-4 sm:gap-6">
              <Link href="/therapist-agreement" className="inline-flex items-center gap-2 rounded-full bg-[#8B1E2D] px-8 py-4 text-sm font-black uppercase tracking-wider text-white shadow-lg shadow-[#8B1E2D]/20 transition hover:bg-[#6E1521] hover:shadow-[#8B1E2D]/40">
                Join MasseurMatch <ArrowRight size={18} />
              </Link>
          ...
          >
            <div className="relative space-y-4">
              <div className="rounded-[24px] border border-[#E8E8E8] bg-white p-8 shadow-md transition hover:shadow-lg">
                ...
                <h3 className="font-display text-lg font-bold text-[#111111]">Premium Profile Setup</h3>
                <p className="mt-2 text-sm text-[#6F6F6F]">Create a professional profile showcasing your expertise, specialties, and approach.</p>
              </div>
              ...
              <div className="rounded-[24px] border border-[#E8E8E8] bg-white p-8 shadow-md transition hover:shadow-lg">
                ...
                <h3 className="font-display text-lg font-bold text-[#111111]">Direct Client Connections</h3>
                <p className="mt-2 text-sm text-[#6F6F6F]">Clients can discover your profile and contact you directly about the professional services you list.</p>
              </div>
              ...
              <div className="rounded-[24px] border border-[#E8E8E8] bg-white p-8 shadow-md transition hover:shadow-lg">
                ...
                <h3 className="font-display text-lg font-bold text-[#111111]">No Booking Commission</h3>
                <p className="mt-2 text-sm text-[#6F6F6F]">MasseurMatch does not process massage-session bookings or take a commission from your off-platform arrangements.</p>
              </div>
            </div>
