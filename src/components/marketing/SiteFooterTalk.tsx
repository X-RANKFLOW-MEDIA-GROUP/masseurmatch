            ...
            {formState === "success" ? (
              ...
              <form onSubmit={handleSubmit} className="mt-8 space-y-4">
                <input
                  ...
                  required
                  className="w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-3.5 text-sm text-white placeholder:text-slate-500 focus:border-[#FF8A1F]/60 focus:outline-none"
                />
                <input
                  name="email"
                  type="email"
                ...
                <textarea
                  ...
                  minLength={10}
                  rows={4}
                  className="w-full resize-none rounded-2xl border border-white/10 bg-white/5 px-4 py-3.5 text-sm text-white placeholder:text-slate-500 focus:border-[#FF8A1F]/60 focus:outline-none"
                />
                {formState === "error" && (
                ...
                <button
                  ...
                  className="inline-flex h-12 w-full items-center justify-center rounded-full bg-[#FF8A1F] px-8 text-sm font-semibold text-white transition-all hover:opacity-90 disabled:opacity-60"
                >
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-white/[0.06] pt-8 md:flex-row">
          ...
          <div className="flex items-center gap-6 font-mono text-[10px] uppercase tracking-widest text-slate-500">
            ...
            <span className="flex items-center gap-1">
              United States <ArrowUpRight className="h-3 w-3 text-[#FF8A1F]" strokeWidth={2.25} />
            </span>
          </div>
        </div>
      </div>
