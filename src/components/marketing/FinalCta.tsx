      ...
      <FadeUp>
        <div className="relative mx-auto max-w-[900px] px-4 text-center sm:px-6 lg:px-8">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
            <Link
              href="/for-therapists"
              className="inline-flex h-12 items-center justify-center rounded-full bg-primary px-8 text-sm font-semibold text-primary-foreground transition-all hover:opacity-90 hover:shadow-[0_0_40px_rgba(200,16,46,0.35)]"
            >
              List your practice
            </Link>
            <Link
