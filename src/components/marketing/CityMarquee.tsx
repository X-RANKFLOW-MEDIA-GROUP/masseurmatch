...
export function CityMarquee() {
  ...
  return (
    <div className="relative overflow-hidden border-y border-white/[0.06] bg-[#060E1A] py-6 lg:py-8">
      {/* Edge fades */}
      <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-24 bg-gradient-to-r from-[#060E1A] to-transparent lg:w-40" />
      <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-24 bg-gradient-to-l from-[#060E1A] to-transparent lg:w-40" />
