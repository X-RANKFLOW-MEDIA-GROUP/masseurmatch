  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 border-b border-white/5 bg-gradient-to-r from-[#8B1E2D]/10 to-transparent px-7 py-5">
        <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-[#8B1E2D] to-[#E67600] text-[#1A1A1A]">
          ...
          <div
            ...
            className={`max-w-[88%] whitespace-pre-line rounded-[18px] px-4 py-3 text-sm leading-relaxed ${
              msg.role === "ai"
                ...
                : "ml-auto bg-gradient-to-r from-[#8B1E2D] to-[#E67600] text-white"
            }`}
          >
            {msg.text}
          </div>
      ...
      <div className="border-t border-white/5 bg-white/[0.02] px-5 py-4">
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#8B1E2D] text-[#1A1A1A] transition hover:bg-[#E67600] disabled:opacity-40"
          >
