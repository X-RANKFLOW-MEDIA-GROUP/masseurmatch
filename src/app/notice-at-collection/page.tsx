...
export const metadata: Metadata = createPageMetadata({
  ...
  description: "Short-form privacy notices at each point of data collection on the MasseurMatch Platform.",
  path: "/notice-at-collection",
});

export default function NoticeAtCollectionPage() {
  return (
    <LegalPage title="Notice at Collection" path="/notice-at-collection" lastUpdated="March 10, 2026">
      <p>
        This section provides the short-form privacy notices that must appear at each point of data collection
        on the MasseurMatch Platform, as required by the California Consumer Privacy Act (CCPA/CPRA) and as
        recommended best practice under the Texas Data Privacy and Security Act (TDPSA).
      </p>
      ...
      <p>
        ...
        which they are used. It is distinct from (and shorter than) the full Privacy Policy.
      </p>
      ...
      <p>
        <em>
          ...
          information. View our full Privacy Policy at [LINK].&rdquo;
        </em>
      </p>
      ...
      <p>
        <em>
          ...
          numbers. See our Privacy Policy [LINK] and Stripe&apos;s Privacy Policy [LINK].&rdquo;
        </em>
      </p>
      ...
      <p>
        <em>
          ...
          communication. It will not be shared with third parties or used for marketing without your consent.&rdquo;
        </em>
      </p>
      ...
      <p>
        <em>
          ...
          time. See our Privacy Policy [LINK].&rdquo;
        </em>
      </p>

      <h2>6. Footer / Global Notice</h2>
      <p>
        The MasseurMatch footer includes a persistent link labeled &ldquo;Privacy Policy&rdquo; which constitutes the
        primary vehicle for full notice of data practices to all visitors. In addition, a first-visit cookie
        banner serves as the notice for cookie-related data collection.
      </p>
      ...
      <p>
        ...
        deletion, to opt out of sale (MasseurMatch does not sell data), and to non-discrimination for
        exercising these rights. To exercise these rights, email{" "}
