...
export default function TrustAndSafetyPage() {
  return (
    <main className="min-h-screen bg-[#FCFBF8] px-6 py-28 text-[#0B1F3A]">
      <section className="mx-auto max-w-3xl">
        <Link href="/" className="font-sans text-xs uppercase tracking-[0.22em] text-[#FF8A1F]">Back to MasseurMatch</Link>
