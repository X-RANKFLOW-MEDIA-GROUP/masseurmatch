...
export async function generateMetadata({ params }: { params: Promise<Params> }): Promise<Metadata> {
  ...
  // Launch URL lists control sitemap/discovery exposure, not whether an otherwise
  // valid canonical city + taxonomy route can render. Legacy redirects depend on
  // these valid combinations returning a real page instead of a 404.
