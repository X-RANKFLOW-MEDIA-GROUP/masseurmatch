...
const navItems = [
  ...
  { name: "My Profile", href: "/pro/profile", icon: UserCircle },
  { name: "Leads", href: "/pro/inquiries", icon: Mail },
  { name: "Performance", href: "/pro/performance", icon: BarChart3 },
  { name: "Plan & Billing", href: "/pro/plan", icon: CreditCard },
  { name: "Settings & Help", href: "/pro/settings", icon: Settings },
] as const;

const routeGroups: Record<string, string[]> = {
  "/pro/profile": ["/pro/profile", "/pro/listing", "/pro/rates", "/pro/photos"],
  "/pro/performance": ["/pro/performance", "/pro/analytics", "/pro/growth", "/pro/ai-coach"],
  "/pro/plan": ["/pro/plan", "/pro/subscription", "/pro/billing", "/pro/payment-history"],
