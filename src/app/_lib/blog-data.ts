...
const FALLBACK_POSTS: BlogListItem[] = [
  ...
  {
    slug: "weekly-city-page-update-checklist",
    category: "For Therapists",
    title: "Weekly City Page Update Checklist for Faster Google Indexation",
    excerpt: "Use this practical weekly workflow to refresh city pages, tighten internal links, and improve mobile clarity so search engines revisit your local pages faster.",
    tags: ["indexation", "city pages", "internal links", "mobile seo", "local seo"],
    date: "April 28, 2026",
    readTime: "9 min read",
  },
  {
...
const FALLBACK_FULL_POSTS: Record<string, BlogPost> = {
  ...
  "weekly-city-page-update-checklist": {
    slug: "weekly-city-page-update-checklist",
    title: "Weekly City Page Update Checklist for Faster Google Indexation",
    excerpt: "A repeatable weekly process to keep city pages fresh, strengthen internal links, and improve mobile readiness for local SEO growth.",
    category: "For Therapists",
    tags: ["indexation", "city pages", "internal links", "mobile seo", "local seo"],
    ...
    author: EDITORIAL_AUTHOR,
    content: [
      { type: "paragraph", content: "If you want Google to recrawl local pages faster, your city content needs consistent, visible updates. A weekly publish rhythm is often more effective than occasional large rewrites because it shows ongoing maintenance and user value." },
      { type: "h2", content: "1) Expand city pages with meaningful copy updates" },
      { type: "paragraph", content: "Add at least one new section that helps users make a decision: neighborhood guidance, service comparison notes, or local trust tips. Avoid repetitive filler text and focus on practical details users actually scan on mobile." },
      { type: "h2", content: "2) Strengthen internal links every week" },
      { type: "paragraph", content: "From the homepage, link to priority cities with varied anchor text. Then cross-link city pages to each other where it makes sense. This creates stronger crawl pathways and helps distribute authority between your most strategic local pages." },
      { type: "h2", content: "3) Publish one new asset weekly" },
      { type: "paragraph", content: "Choose either a fresh city page or a supporting blog post that references active city routes. New content gives crawlers more reasons to revisit your site and broadens topical coverage around your target queries." },
      { type: "h2", content: "4) Refresh metadata and click appeal" },
      { type: "paragraph", content: "Write unique meta descriptions that mention city-specific context, trust signals, and clear outcomes. Better snippets improve click-through rate, and stronger engagement can indirectly reinforce your page performance over time." },
      { type: "h2", content: "5) Validate mobile UX before publishing" },
      { type: "ul", content: ["Confirm no text clipping in city banners.", "Check tap targets and link spacing for thumbs.", "Ensure fast loading of hero and listing sections.", "Verify that key links are visible without excessive scrolling."] },
      { type: "blockquote", content: "Weekly consistency beats occasional perfection. Treat city SEO like product development: ship updates, measure behavior, and iterate." },
    ],
  },
};
