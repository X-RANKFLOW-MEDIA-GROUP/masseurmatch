...
const DALLAS_CATEGORY_COPY: Record<string, Omit<CanonicalCategory, "slug">> = {
  "gay-massage": {
    ...
    title: "Gay Massage in Dallas, TX | Male Massage Therapists | MasseurMatch",
    h1: "Dallas Gay Massage and Male Massage Therapists",
    intro:
      "Find gay massage in Dallas through a city-first directory built for direct contact and stronger trust signals. This page focuses on independent male therapists, clear incall and outcall options, visible starting rates, and neighborhood context that helps you decide quickly. Compare profile quality, specialties, and response preferences in one place instead of jumping across thin listings. Dallas is the beachhead market for MasseurMatch, so this route is optimized for high-intent local search and cleaner user journeys. Use it to move from broad city discovery into service, session type, and neighborhood pages without losing relevance.",
  },
  "male-massage": {
    label: "Male Massage",
    kind: "service",
    primaryKeyword: "male massage dallas",
    title: "Male Massage in Dallas, TX | Male Massage Therapists | MasseurMatch",
    h1: "Male Massage in Dallas, TX",
    intro:
      "Browse male massage listings in Dallas with profile depth, transparent session formats, and direct contact actions. Instead of shallow directory cards, this page emphasizes trust signals, neighborhood coverage, and entry pricing so users can shortlist confidently. Dallas remains the primary proving ground for MasseurMatch over the next 60 to 90 days, which means this page receives focused internal links from city, guide, and neighborhood clusters. Use it as the main route for broad male massage intent, then pivot into deep tissue, Swedish, outcall, or local micro-area pages based on your exact needs.",
  },
  "deep-tissue": {
    label: "Deep Tissue Massage",
    kind: "service",
    primaryKeyword: "deep tissue massage dallas",
    title: "Deep Tissue Massage in Dallas, TX | Male Massage Therapists | MasseurMatch",
  ...
  swedish: {
    ...
    title: "Swedish Massage in Dallas, TX | Male Massage Therapists | MasseurMatch",
    h1: "Swedish Massage in Dallas, TX",
    intro:
      "Find Swedish massage in Dallas through a premium city page that balances calm presentation with high-intent SEO structure. This route highlights therapists who clearly communicate session style, comfort, and boundaries while keeping pricing and service format visible. Dallas is being used as the main beachhead market, so this page connects tightly to neighborhood pages and editorial guides that support user confidence. Compare listings by trust status, location context, and direct-contact readiness. If you want restorative maintenance rather than high-pressure bodywork, this is the best starting point before drilling into local micro-areas.",
  },
  "sports-massage": {
    label: "Sports Massage",
    kind: "service",
    primaryKeyword: "sports massage dallas",
    title: "Sports Massage in Dallas, TX | Male Massage Therapists | MasseurMatch",
  ...
  incall: {
    ...
    title: "Incall Massage in Dallas, TX | Male Massage Therapists | MasseurMatch",
  ...
  outcall: {
    ...
    title: "Outcall Massage in Dallas, TX | Male Massage Therapists | MasseurMatch",
  ...
  mobile: {
    ...
    title: "Mobile Massage in Dallas, TX | Male Massage Therapists | MasseurMatch",
  ...
  hotel: {
    ...
    title: "Hotel Massage in Dallas, TX | Male Massage Therapists | MasseurMatch",
  ...
  "oak-lawn": {
    ...
    title: "Gay Massage in Oak Lawn, Dallas, TX | Male Massage Therapists | MasseurMatch",
  ...
  "turtle-creek": {
    ...
    title: "Gay Massage in Turtle Creek, Dallas, TX | Male Massage Therapists | MasseurMatch",
    h1: "Gay Massage in Turtle Creek, Dallas",
    intro:
      "Explore Turtle Creek gay massage listings through a page tailored for micro-area search behavior in Dallas. Users can compare active profiles, session formats, and starting rates while keeping local context central to the decision. This route supports the Dallas-first cluster by connecting neighborhood intent to high-performing service and guide pages. Direct contact stays at the core, with less noise and clearer profile signals than broad marketplaces. Use Turtle Creek as a focused entry point when location fit and efficient outreach matter as much as modality and provider presentation.",
  },
  uptown: {
    label: "Uptown",
    kind: "neighborhood",
    primaryKeyword: "uptown dallas male massage",
    title: "Gay Massage in Uptown, Dallas, TX | Male Massage Therapists | MasseurMatch",
  ...
  "medical-district": {
    ...
    title: "Male Massage in Medical District, Dallas, TX | Massage Therapists | MasseurMatch",
  ...
  "university-park": {
    ...
    title: "Gay Massage in University Park, Dallas, TX | Male Massage Therapists | MasseurMatch",
  ...
  "love-field": {
    ...
    title: "Gay Massage near Love Field, Dallas, TX | Male Massage Therapists | MasseurMatch",
...
export function getCanonicalCategoryForCity(cityCanonicalSlug: string, categorySlug: string): CanonicalCategory | null {
  ...
  if (dfwSuburbMatch && categorySlug === "gay-massage") {
    return {
      ...
      title: `Gay Massage in ${cityCanonicalSlug.replace(/-/g, " ")} | Male Massage Therapists | MasseurMatch`,
