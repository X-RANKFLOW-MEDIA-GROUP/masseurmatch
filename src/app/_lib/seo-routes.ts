...
const CORE_STATIC_ROUTES: StaticSitemapRoute[] = [
  ...
  // Document catalog policy pages
  { path: "/content-guidelines", changeFrequency: "monthly", priority: 0.45 },
  { path: "/provider-terms", changeFrequency: "monthly", priority: 0.45 },
  { path: "/client-terms", changeFrequency: "monthly", priority: 0.45 },
  { path: "/acceptable-use", changeFrequency: "monthly", priority: 0.4 },
  { path: "/prohibited-conduct", changeFrequency: "monthly", priority: 0.4 },
  { path: "/photo-profile-policy", changeFrequency: "monthly", priority: 0.4 },
  { path: "/badge-disclaimer", changeFrequency: "monthly", priority: 0.4 },
  { path: "/subscriptions", changeFrequency: "monthly", priority: 0.45 },
  { path: "/refund-policy", changeFrequency: "monthly", priority: 0.45 },
  { path: "/advertising-terms", changeFrequency: "monthly", priority: 0.4 },
  { path: "/ai-disclosure", changeFrequency: "monthly", priority: 0.4 },
  { path: "/sms-terms", changeFrequency: "monthly", priority: 0.4 },
  { path: "/email-opt-out", changeFrequency: "monthly", priority: 0.4 },
  { path: "/dmca", changeFrequency: "monthly", priority: 0.45 },
  { path: "/report-block-safety", changeFrequency: "monthly", priority: 0.45 },
