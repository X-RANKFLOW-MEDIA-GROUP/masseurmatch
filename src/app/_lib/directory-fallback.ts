...
export const FALLBACK_PUBLIC_THERAPISTS: FallbackTherapist[] = [
  ...
  },
  {
    ...
    full_name: "KevinOS",
    bio: "Certified massage therapist with over 8 years of experience. Offering deep tissue, acupressure, and head massage in a relaxing environment with music and aromatherapy. Professional, focused on your well-being and total relaxation. Incall and outcall available.",
    avatar_url: null,
    phone: null,
  ...
  },
  {
    ...
    bio: "Brazilian-trained therapist with 14 years of experience in Oak Lawn, Dallas. Specializes in Deep Tissue, Swedish, Hot Stone, Shiatsu, AMMA Therapy, Lymphatic Drainage, Myofascial Release, and Zero Balancing. Studio and mobile outcall available. LGBT+ welcoming.",
    avatar_url: null,
    phone: "+17623345300",
