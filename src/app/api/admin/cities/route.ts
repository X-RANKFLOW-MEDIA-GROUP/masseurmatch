...
export async function POST(request: Request) {
  try {
    ...
    await import("@/app/_lib/revalidate").then(({ buildCityRevalidatePaths, triggerRevalidate }) =>
      buildCityRevalidatePaths(city.slug).then((paths) => triggerRevalidate(paths, { request }))
    ).catch((error) => {
