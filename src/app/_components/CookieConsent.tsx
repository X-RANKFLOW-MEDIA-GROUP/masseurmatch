        ...
        <div className="space-y-3">
          <div>
            ...
            <p className="mt-1.5 text-sm leading-6 text-slate-600">
              ...
              <Link href="/cookie-policy" className="font-semibold text-[#1A1A1A] underline underline-offset-2 hover:text-[#C8102E]">
                Cookie Policy
              </Link>
              .
            </p>
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <button
              ...
              className="min-h-10 rounded-lg bg-[#C8102E] px-3 text-sm font-semibold text-[#1A1A1A] shadow-sm transition-colors hover:bg-[#A80D24] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#C8102E]"
            >
              Accept
            </button>
          </div>
