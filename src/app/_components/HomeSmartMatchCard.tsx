      ...
      {showStickyCta ? (
        <div className="fixed inset-x-3 bottom-3 z-40 md:hidden">
          <button
            ...
            className="flex w-full items-center justify-center rounded-full bg-action-primary px-5 py-3.5 text-sm font-semibold text-white shadow-[0_18px_40px_rgba(200,16,46,0.28)]"
          >
