...
export const metadata: Metadata = createPageMetadata({
  ...
  description:
    "How MasseurMatch subscription billing works, how to cancel, when refunds apply, and how failed payments are handled.",
  path: "/billing",
  keywords: ["billing", "cancellation", "refund policy", "subscription", "stripe", "therapist listing"],
});

export default function BillingPage() {
  return (
    <LegalPage title="Billing, Cancellation & Refund Policy" path="/billing">
      <p>
      ...
      <p>
        ...
        described on the{" "}
        <a href="/pricing">Pricing page</a> and may vary by plan tier.
      </p>
      ...
      <ul>
        <li>
          <strong>Online (preferred):</strong> Account Settings &rarr; Subscription &rarr; Cancel Subscription
        </li>
        <li>
          <strong>Email:</strong>{" "}
      ...
      <blockquote>
        &ldquo;By clicking &lsquo;Subscribe,&rsquo; you agree to a recurring charge at the selected plan rate,
        charged to your selected payment method. Subscription renews automatically until canceled. Cancel anytime
        in Account Settings. No prorated refunds for partial periods. See Billing Policy for details.&rdquo;
      </blockquote>
    </LegalPage>
  );
}
