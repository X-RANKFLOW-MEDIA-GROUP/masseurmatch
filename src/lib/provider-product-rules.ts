type ProviderTier = "free" | "standard" | "pro" | "elite";

export const MAX_RATE_PER_MINUTE = 3.33;

const AVAILABLE_NOW_RULES: Record<ProviderTier, { durationMinutes: number; activationsPerDay: number | null }> = {
...
const TRAVEL_DESTINATION_LIMITS: Record<ProviderTier, number | null> = {
  free: 1,
  standard: 3,
  pro: null,
  elite: null,
...
function normalizeProviderTier(value: string | null | undefined): ProviderTier {
