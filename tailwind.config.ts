    ...
    extend: {
      colors: {
        ...
        badge: {
          ...
          "verified-light": "hsl(var(--badge-verified-light))",
          "verified-border": "hsl(var(--badge-verified-border))",
          available: "hsl(var(--badge-available))",
          "available-light": "hsl(var(--badge-available-light))",
          "available-border": "hsl(var(--badge-available-border))",
          offer: "hsl(var(--badge-offer))",
          "offer-light": "hsl(var(--badge-offer-light))",
          "offer-border": "hsl(var(--badge-offer-border))",
          promo: "hsl(var(--badge-promo))",
          "promo-light": "hsl(var(--badge-promo-light))",
          "promo-border": "hsl(var(--badge-promo-border))",
        },
        brand: {
