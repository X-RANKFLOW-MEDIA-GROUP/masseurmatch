      ...
      <div
        ...
        style={
          msg.role === "user"
            ...
            : {
                background: "rgb(var(--color-bg-surface-rgb) / 0.9)",
                backdropFilter: "blur(12px)",
                border: "1px solid rgb(var(--color-border-subtle-rgb) / 0.85)",
      ...
      <AnimatePresence mode="wait">
        {!isOpen ? (
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                boxShadow: "0 0 30px hsl(var(--primary) / 0.18), inset 0 1px 0 rgb(var(--color-text-inverse-rgb) / 0.16)",
              }}
            >
              ...
              {isHovered && (
                ...
                >
                  <div
                    ...
                    style={{
                      background: "rgb(var(--color-bg-surface-rgb) / 0.94)",
                      backdropFilter: "blur(16px)",
                      border: "1px solid rgb(var(--color-border-subtle-rgb) / 0.9)",
                    }}
                  >
                    Ask Knotty ✨
                  </div>
          ...
          <motion.div
            ...
            style={{
              background: "linear-gradient(180deg, rgb(var(--color-bg-surface-rgb) / 0.96), rgb(var(--color-bg-body-rgb) / 0.98))",
              backdropFilter: "blur(40px) saturate(1.12)",
              border: "1px solid rgb(var(--color-border-subtle-rgb) / 0.88)",
              borderRadius: "20px",
              boxShadow: `
                0 28px 72px rgb(var(--color-brand-primary-rgb) / 0.16),
                0 0 0 1px rgb(var(--color-border-subtle-rgb) / 0.72),
                inset 0 1px 0 rgb(var(--color-text-inverse-rgb) / 0.5)
              `,
            }}
          >
            {/* Glass shine overlay */}
            <div
              ...
              style={{
                background: "linear-gradient(135deg, rgb(var(--color-brand-secondary-rgb) / 0.08) 0%, transparent 42%, transparent 60%, rgb(var(--color-brand-accent-rgb) / 0.06) 100%)",
              }}
            />
            ...
            <div
              ...
              style={{
                borderBottom: "1px solid rgb(var(--color-border-subtle-rgb) / 0.9)",
            ...
            >
              <div className="flex items-center gap-3">
                <div
                  ...
                  style={{
                    background: "linear-gradient(135deg, var(--color-brand-secondary), var(--color-action-primary))",
                    border: "1px solid rgb(var(--color-border-subtle-rgb) / 0.9)",
                    boxShadow: "0 10px 24px rgb(var(--color-brand-primary-rgb) / 0.14)",
                  }}
                >
              ...
              <motion.button
                ...
                style={{
                  background: "rgb(var(--color-bg-body-rgb) / 0.92)",
                  border: "1px solid rgb(var(--color-border-subtle-rgb) / 0.88)",
                }}
              >
                <X className="w-4 h-4" />
              ...
              {isTyping && (
                ...
                >
                  <div
                    ...
                    style={{
                      background: "rgb(var(--color-bg-surface-rgb) / 0.88)",
                      backdropFilter: "blur(12px)",
                      border: "1px solid rgb(var(--color-border-subtle-rgb) / 0.88)",
                    }}
                  >
            ...
            <div
              ...
              style={{ borderTop: "1px solid rgb(var(--color-border-subtle-rgb) / 0.88)" }}
            >
              <form
              ...
              >
                ...
                <motion.button
                  ...
                  className="w-8 h-8 rounded-full flex items-center justify-center text-accent-foreground disabled:opacity-20 transition-all"
                  style={{
                    background: input.trim()
                      ? "linear-gradient(135deg, var(--color-action-primary), var(--color-action-primary-hover))"
                      : "rgb(var(--color-bg-subtle-rgb) / 0.9)",
                    boxShadow: input.trim() ? "0 10px 24px rgb(var(--color-brand-primary-rgb) / 0.16)" : "none",
                  }}
                >
