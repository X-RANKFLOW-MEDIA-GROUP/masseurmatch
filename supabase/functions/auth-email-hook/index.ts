...
const SENDER_DOMAIN = "notify.masseurmatch.com"
const ROOT_DOMAIN = "masseurmatch.com"
const FROM_DOMAIN = "masseurmatch.com" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://masseurmatch.com"
...
async function handleWebhook(req: Request): Promise<Response> {
  ...
  // SECURITY: Do not log PII (email addresses) - use run_id for correlation
