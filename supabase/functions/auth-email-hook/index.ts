    ...
    <tr><td align="center">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" style="max-width:600px;background:#FFFFFF;border:1px solid #ECE4E4;border-radius:14px;overflow:hidden">
        <tr><td style="background:#0B1F3A;padding:22px 28px 24px">
          <span style="display:inline-block;background:#FF8A1F;color:#FFFFFF;font-size:11px;letter-spacing:0.08em;text-transform:uppercase;font-weight:700;padding:7px 10px;border-radius:999px;margin-bottom:10px">${badge}</span>
        ...
        <tr><td style="padding:0 28px"><hr style="border:none;border-top:1px solid #ECE4E4;margin:0" /></td></tr>
...
function btn(text: string, url: string): string {
  return `<a href="${url}" style="display:inline-block;background:#FF8A1F;color:#FFFFFF;text-decoration:none;font-size:15px;font-weight:700;padding:12px 24px;border-radius:8px;margin-top:8px">${text}</a>`;
}
    ...
    case "signup":
      return {
        ...
        html: shell("Confirm Your Email", `
          ...
          <p style="font-size:13px;color:#71717a;margin-top:20px">This link expires in 24 hours.</p>
        `),
      };
    ...
    case "recovery":
      return {
        ...
        html: shell("Reset Your Password", `
          ...
          <p style="font-size:13px;color:#71717a;margin-top:20px">This link expires in 1 hour. If you didn't request this, you can ignore this email.</p>
        `, "Security"),
      };
    ...
    case "magiclink":
      return {
        ...
        html: shell("Your Login Link", `
          ...
          <p style="font-size:13px;color:#71717a;margin-top:20px">This link expires in 1 hour.</p>
        `),
      };
    ...
    case "email_change":
      return {
        ...
        html: shell("Confirm Your New Email", `
          ...
          <p style="font-size:13px;color:#71717a;margin-top:20px">If you didn't request an email change, contact support immediately.</p>
        `, "Security"),
      };
    ...
    case "reauthentication":
      return {
        ...
        html: shell("Your Verification Code", `
          ...
          <div style="background:#F4F6FB;border:1px solid #ECE4E4;border-radius:10px;padding:20px;text-align:center;margin-bottom:20px">
            <span style="font-size:36px;font-weight:700;letter-spacing:0.15em;color:#0B1F3A">${emailData.token}</span>
          </div>
