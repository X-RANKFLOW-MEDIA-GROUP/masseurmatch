...
create index if not exists demand_radar_spike_alert_deliveries_profile_idx on public.demand_radar_spike_alert_deliveries(profile_id, created_at desc);
create index if not exists demand_radar_spike_alert_deliveries_run_idx on public.demand_radar_spike_alert_deliveries(run_id, created_at desc);
